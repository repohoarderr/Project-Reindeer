...
public class Features {
  ...
  public static JSONObject featureJSON(Shape shape) { //Add the shape to the feature list in JSON format
...
//            jsonWriter.put("type", "Arc2D");
    ...
    } else { // default to this if the shape does fall under any category
